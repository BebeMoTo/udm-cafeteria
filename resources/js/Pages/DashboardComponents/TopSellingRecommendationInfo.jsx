...
function TopSellingRecommendationInfo({ item, open, onClose, additional_fee }) {
...
TopSellingRecommendationInfo.propTypes = {
  item: PropTypes.object.isRequired,
  open: PropTypes.bool.isRequired,
  onClose: PropTypes.func.isRequired,
};

export default TopSellingRecommendationInfo;
